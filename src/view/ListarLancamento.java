 ...
 * @author vMp
 */
public class ListarLancamento extends javax.swing.JFrame {

    /**
     * Creates new form ListarLancamento
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarLancamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
